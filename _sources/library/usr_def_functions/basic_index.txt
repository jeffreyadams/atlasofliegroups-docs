...
.. list-table::
   ...
   * - :ref:`max_([int]->int)`
     - ``([int]->int)``
   * - :ref:`min_loc_([int]->int)`
     - ``([int]->int)``
   * - :ref:`max_loc_([int]->int)`
     - ``([int]->int)``
   * - :ref:`min_(int->([int]->int))`
     - ``(int->([int]->int))``
   * - :ref:`max_(int->([int]->int))`
   ...
   * - :ref:`plural_(int->string)`
     - ``(int->string)``
   * - :ref:`plural_(int,string->string)`
     - ``(int,string->string)``
   * - :ref:`concat_([string]->string)`
     - ``([string]->string)``
   * - :ref:`l_adjust_(int,string->string)`
     - ``(int,string->string)``
   * - :ref:`r_adjust_(int,string->string)`
     - ``(int,string->string)``
   * - :ref:`c_adjust_(int,string->string)`
     - ``(int,string->string)``
   * - :ref:`width_(int->int)`
     - ``(int->int)``
   ...
   * - :ref:`Cayley_(vec,KGBElt->KGBElt)`
     - ``(vec,KGBElt->KGBElt)``
   * - :ref:`W_cross_([int],KGBElt->KGBElt)`
     - ``([int],KGBElt->KGBElt)``
   ...
   * - :ref:`lookup_(Param,[Param]->int)`
     - ``(Param,[Param]->int)``
   * - :ref:`has_double_extended_Cayley_(int->bool)`
     - ``(int->bool)``
   * - :ref:`print_extended_block_(Param,mat->)`
     - ``(Param,mat->)``
   ...
   * - :ref:`divide_by_(int,ParamPol->ParamPol)`
...
.. list-table::
   ...
   * - Variable
     - Data Type
   * - :ref:`extended_status_texts_[string]`
     - ``[string]``
