...
| 
| The set of KGP elements associated to a RealForm and a set of simple roots S; KGP(G,S) is in bijection with K\G/P_S
| 
...
| 
| Test whether y in K\G/P_S is open: <=> last element of y is last element of KGB
| 
