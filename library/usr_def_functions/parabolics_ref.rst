...
| 
| Test if a complex Levi defined by a set of simple roots S is :math:`\theta_x`-stable;   algorithm: H=sum of fundamental coweights with index not in S,   test whether :math:`<\theta_x(\alpha),H>=0` for all :math:`\alpha`
| 
...
| 
| Make a real Levi factor from P=(S,x), the complex Levi of S must be :math:`\theta_x`
| 
...
| 
| Test if parabolic P=(S,x) is :math:`\theta`-stable: <=>   1) the complex Levi factor L is :math:`\theta`-stable   2) the KGP element P is closed (see kgp.at)   3) :math:`\alpha` simple, not in S => :math:`\alpha`
| 
...
| 
| Test if parabolic P=(S,x) is real: <=>:   1) L is :math:`\theta`-stable   2) P is open   3) :math:`\alpha` simple, not in S => :math:`\alpha`
| 
...
| 
| Half sum of positive roots not in the Levi (L must be :math:`\theta`
| 
...
| 
| Half sum of positive roots in the Levi (L must be :math:`\theta`
| 
...
| 
| Positive coroots in the nilradical u of P (L must be :math:`\theta`
| 
...
| 
| Positive roots in the nilradical u of P (L must be :math:`\theta`
| 
...
| 
| Simple coroots on which weight lambda (in :math:`\mathfrak h^*`
| 
...
| 
| Positive coroots in nilradical of P defined by lambda (if L :math:`\theta`
| 
...
| 
| Positive roots in nilradical of P defined by lambda (if L :math:`\theta`
| 
...
| 
| Half sum of positive roots in nilradical of P defined by lambda (if L :math:`\theta`
| 
...
| 
| Positive coroots in nilradical of P defined by coweight H (if L :math:`\theta`
| 
...
| 
| Positive roots in nilradical of P defined by coweight H (if L :math:`\theta`
| 
...
| 
| Half sum of roots in nilradical of P defined by H (if L :math:`\theta`
| 
...
| 
| :math:`\rho(L)` for Levi of P defined by H (if L :math:`\theta`
| 
...
| 
| List K-conjugacy classes of given ComplexParablic that are :math:`\theta`
| 
