...
* :ref:`session_4A`
* :ref:`session_4B`
* :ref:`windows_setup`: downloading and installing atlas under Windows. (Out of date)
* :ref:`realex_getting_started`: getting started with realex (aka. atlas). (Out of date)
* :ref:`modules`: This (long) video explains some new features of realex (aka. atlas), including "modules" notation I(p) and J(p), translation functors, and coherent continuation. (Out of date)
