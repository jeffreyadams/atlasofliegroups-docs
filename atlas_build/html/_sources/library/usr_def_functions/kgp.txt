...
parabolic :math:`P_S` (see parabolics.at) of type S. We define a set KGP(S) (a
quotient of KGB) such that (roughly) KGP(S) <-> :math:`K\G/P_S`.

More precisely, for any :math:`x\in` KGB and :math:`p(\xi)=x`,
KGP(S) is canonically in bijection with :math:`K_\xi\G/P_S`; i.e.,
