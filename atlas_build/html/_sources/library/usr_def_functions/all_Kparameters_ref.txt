...
reduce
-------------------------------------------------
| ``reduce:([(KGBElt,ratvec)]->[(KGBElt,ratvec)])``
| 
...
-------------------------------------------------
| ``basis_lambda_differential_0:(KGBElt->mat)``
| 
...
-------------------------------------------------
| ``all_lambda_differential_0:(KGBElt->[vec])``
| 
...
-------------------------------------------------
| ``all_equal_dlambda_K_parameters:(KGBElt,ratvec->[(KGBElt,ratvec)])``
| 
...
-------------------------------------------------
| ``all_parameters_gamma:(RealForm,ratvec->[Param])``
| 
...
-------------------------------------------------
| ``all_dominant_norm_upto:(InnerClass,ratvec,int->mat)``
| 
...
-------------------------------------------------
| ``lambda_rho_from_dominant_norm_upto:(KGBElt,ratvec,int->mat)``
| 
...
-------------------------------------------------
| ``K_parameters_norm_upto:(KGBElt,ratvec,int->[(KGBElt,ratvec)])``
| 
